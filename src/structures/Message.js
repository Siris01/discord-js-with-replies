...
class Message extends Base {
  ...
  reply(content, options) {
    ...
    if (!options.allowedMentions.repliedUser) options.allowedMentions.repliedUser = false;
    return this.channel.send(
      content instanceof APIMessage
        ? content
        : APIMessage.transformOptions(content, options, {
            replyTo: (this.deleted || !this.channel.permissionsFor(this.guild.me).has('READ_MESSAGE_HISTORY'))? null: this,
          }),
    );
  }
